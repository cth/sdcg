...
pronoun(sing,first,subjective,@gender(_G)) ==> [ I ].
pronoun(sing,first,objective,@gender(_G)) ==> [ me ].
pronoun(sing,first,possesive-determiner,@gender(_G)) ==> [ my ].
pronoun(sing,first,possesive-nominal‚@gender(_G)) ==> [ mine ].

% first-person plural (we) - inclusive (you and I) and exclusive (someone else and I but not you)
pronoun(plur,first,subjective,@gender(_G)) ==> [ we ].
pronoun(plur,first,objective,@gender(_G)) ==> [ us ].
pronoun(plur,first,possesive-determiner,@gender(_G)) ==> [ our ].
pronoun(plur,first,possesive-nominal,@gender(_G)) ==> [ ours ].
...
pronoun(@num(_Number),second,subjective,@gender(_G)) ==> [ you ].

pronoun(sing,third,subjective,masc) ==> [ he ].
pronoun(sing,third,objective,masc) ==> [ him ].
pronoun(sing,third,@possessive(_C),masc) ==> [ his ].
...
pronoun(plur,third,@subj_obj(_C),neut) ==> [ it ].
pronoun(plur,third,@possessive(_C),neut) ==> [ its ].

pronoun(plur,third,subjective,@gender(_G)) ==> [ they ].
pronoun(plur,third,objective,@gender(_G)) ==> [ them ].
pronoun(plur,third,possesive-determiner,@gender(_G)) ==> [ their ].
pronoun(plur,third,possesive-nominal,@gender(_G)) ==> [ theirs ].

pronoun(sing,first,reflexive,@gender(_G)) ==> [ myself ].
pronoun(plur,first,reflexive,@gender(_G)) ==> [ ourselves ].
pronoun(sing,second,reflexive,@gender(_G)) ==> [ yourself ].
pronoun(plur,second,reflexive,@gender(_G)) ==> [ yourselves ].
...
pronoun(plur,third,reflexive,@gender(_G)) ==> [ themselves ].

% These are not really pronouns are they? Anyway, they are _not_ countable!
pronoun(sing,third,@subj_obj(_C),neut) ==> [ Alaska ].
pronoun(sing,third,@subj_obj(_C),neut) ==> [ Baltimore ].

% We don't allow nouns containing spaces. We consider them as two nouns.
%pronoun(sing,third,@subj_obj(_C),neut) ==> [ Los Angeles ].
%pronoun(sing,third,@subj_obj(_C),neut) ==> [ New York ].
...
relative_pronoun(@num(_Number),third,neut) ==> [that].
relative_pronoun(@num(_Number),third,@human(_G)) ==> [who].



% We are going to have a separate wh-category
%pronoun(interogative,third,@subj_obj,@gender(_G)) ==> [ who ].
%pronoun(interogative,third,objective,@gender(_G)) ==> [ whom ].
%pronoun(interogative,third,genitive,@gender(_G)) ==> [ whose ].